...
const DashboardPage: React.FC<DashboardPageProps> = ({ user, onLogout }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-sky-100 via-indigo-100 to-purple-200 overflow-y-auto animate-fadeIn">
        <div className="animate-slideInRight">
          <Routes>
            ...
            <Route path={progressBase} element={<ProgressPage user={user} />} />{" "}
            {/* Pass user */}
