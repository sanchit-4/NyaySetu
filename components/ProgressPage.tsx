...
const ProgressPage: React.FC<ProgressPageProps> = ({ user }) => {
  ...
  return (
    <div className="relative min-h-screen animate-fadeIn bg-gradient-to-br from-gray-50 to-blue-50">
      <FloatingParticles />
      <div className="p-4 sm:p-6 lg:p-8">
        <header className="mb-8 pb-6 border-b border-gray-300/50 backdrop-blur-sm rounded-xl p-6 float-animation">
        ...
        <div className="mb-10 p-6 bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border-t-4 border-primary pulse-glow">
